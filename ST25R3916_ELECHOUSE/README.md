...
- `ESP32_I2C_probe_chip`, `ESP32_I2C_scan_14443A`, `ESP32_I2C_icode_slix2_read_write_test`, and `ESP32_I2C_iso14443b_ndef_write_test` are hardware-validated on `ESP32 Dev Module`.
