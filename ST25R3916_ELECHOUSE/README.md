...
- Bring-up transport: `I2C` (first-pass ESP32 hardware-validated for chip probe, `ISO14443A`, S70 read/auth/dump diagnostics, `ISO15693` `ICODE SLIX2` read/write/restore, and `ISO14443B / Type 4B` NDEF write/read/restore)
...
- I2C examples default to `SDA=21`, `SCL=22`, `IRQ=4`, `100kHz`; the guarded S70 write-test sketch uses `400kHz` when write mode is explicitly enabled.
