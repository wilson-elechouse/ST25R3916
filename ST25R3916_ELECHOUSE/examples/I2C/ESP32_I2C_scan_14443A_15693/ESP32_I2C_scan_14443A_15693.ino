/*
  Example: ESP32_I2C_scan_14443A_15693
  Bus: I2C
  Wiring: SDA=21, SCL=22, IRQ=4, LED=2 (optional)
  Cards: ISO14443A, ISO15693
  Goal: Extended I2C scan example after the minimal 14443A path is stable.
  Common failures: same as the basic I2C example, plus unstable rediscovery when the IRQ line is noisy.
*/
...
void setup()
{
  ...
  Serial.println("ESP32 I2C 14443A + 15693 scanner");
  Serial.print("SDA=");
